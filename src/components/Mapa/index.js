      ...
      <div className="bg-blue-700 w-2/5 md:w-fit md:h-fit p-2 md:p-4 absolute top-0 md:top-1/4 md:left-20 flex md:gap-3 justify-between">
        ...
        <div className="hidden md:flex md:flex-col  justify-center text-xs">
          <div className="flex md:gap-2">
            <Link href="https://www.google.com/maps/dir/Impresilk+Solu%C3%A7%C3%B5es+Visuais+-+Av.+Fel%C3%ADciano+Martins+de+Freitas,+127+-+Vila+Regina,+Montes+Claros+-+MG,+39400-207/@-16.7014315,-43.8750843,15z/data=!4m9!4m8!1m0!1m5!1m1!1s0x754ab5a9cf15555:0x647818a8b55dca40!2m2!1d-43.8594299!2d-16.7126121!3e0
" target='_blank'>
